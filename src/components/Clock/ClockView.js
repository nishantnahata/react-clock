...
export class ClockView extends React.Component {
  ...
  drawFace = (ctx, radius) => {
    ...
    grad.addColorStop(0, this.props.clockColor);
    grad.addColorStop(0.5, this.props.backgroundColor);
    grad.addColorStop(1, this.props.clockColor);
  ...
  render() {
    return (
      <div>
        <canvas
          id="clock"
          ref={ref => this.setUpClock(ref)}
          height={this.props.size}
          width={this.props.size}
          style={{ backgroundColor: this.props.clockColor }}
        />
      </div>
    );
  }
